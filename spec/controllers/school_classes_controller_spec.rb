  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SchoolClass" do
        expect {
          post :create, {:school_class => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, {:school_class => invalid_attributes}, valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested school_class" do
        school_class = SchoolClass.create! valid_attributes
        put :update, {:id => school_class.to_param, :school_class => new_attributes}, valid_session
        school_class.reload
      ...
      it "redirects to the school_class" do
        school_class = SchoolClass.create! valid_attributes
        put :update, {:id => school_class.to_param, :school_class => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        school_class = SchoolClass.create! valid_attributes
        put :update, {:id => school_class.to_param, :school_class => invalid_attributes}, valid_session
        expect(response).to be_successful
      end
    end
  end
